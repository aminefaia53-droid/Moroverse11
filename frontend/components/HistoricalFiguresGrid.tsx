                    ...
                    {filteredFigures.map((figure, idx) => (
                        ...
                        >
                            <div className="moro-glass p-8 rounded-[40px] border border-primary/10 hover:border-primary/40 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 relative overflow-hidden bg-white/60 h-[420px] flex flex-col justify-between">
                                ...
                                <div className="absolute -right-6 -top-6 opacity-[0.03] group-hover:opacity-10 transition-all duration-700 transform group-hover:scale-125 group-hover:rotate-12">
                                ...
                                <div className="relative z-10 flex flex-col h-full">
                                    ...
                                    <div className="flex justify-between items-start mb-6">
                                        <div className="w-14 h-14 rounded-2xl bg-primary/5 border border-primary/10 flex items-center justify-center group-hover:bg-primary transition-all duration-500 shadow-sm">
                                        ...
                                        <div className="px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-[9px] font-bold text-slate-500 uppercase tracking-wider max-w-[50%] text-center leading-tight">
                                            {figure.era[lang]}
                                        </div>
                                    </div>
                                    ...
                                    {/* Name & Specialty */}
                                    <div className="mb-4">
                                        <h3 className="text-2xl font-black text-foreground/80 mb-2 leading-tight">
                                            {figure.name[lang]}
                                        </h3>
                                    ...
                                    <div className="flex-grow mt-2">
                                        <p className="text-sm text-foreground/60 leading-relaxed max-h-32 overflow-hidden text-ellipsis line-clamp-4">
                                            {figure.shortBio[lang]}
                                        </p>
                                    </div>

                                    {/* Decorative bottom line */}
                                    <div className="w-full h-1 bg-gradient-to-r from-transparent via-primary/20 to-transparent mt-4 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700" />
                                </div>
                            </div>
                        </motion.div>
                    ))}
