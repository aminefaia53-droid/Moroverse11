...
const generateContent = () => {
    // Helper to generate long Arabic texts
...
export const getArticle = (id: string, nameAr: string, nameEn: string, category: 'battle' | 'landmark' | 'city' | 'figure'): MoroArticle => {
    ...
    const battleImages = [
        'https://images.unsplash.com/photo-1599839619722-39751411ea63?q=80&w=2070&auto=format&fit=crop', // Cinematic knights/horses
        'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?q=80&w=2070&auto=format&fit=crop', // Majestic desert riders
        'https://images.unsplash.com/photo-1587595431973-160d0d94add1?q=80&w=2076&auto=format&fit=crop'  // Moroccan architecture / fortress
    ];
    
    const standardImages = [
        'https://images.unsplash.com/photo-1549429440-660c608fba63?q=80&w=2070&auto=format&fit=crop', // Moroccan Sahara
        'https://images.unsplash.com/photo-1548013146-72479768bada?q=80&w=2076&auto=format&fit=crop', // Medina
        'https://images.unsplash.com/photo-1563825828551-fb18e47aa571?q=80&w=2070&auto=format&fit=crop'  // Details/Zellige
    ];
    ...
    return {
        ...
        metaDescription: {
            ...
            en: \`Deep comprehensive historical analysis about \${nameEn} detailing its cultural impact through MoroVerse Interactive Digital Archives.\`
        },
        intro: {
            ar: \`تمثل \${nameAr} صفحة مشرقة لا تُنسى في تراث وصفحات المملكة المغربية العريقة التي امتدت جذورها عبر قرون من المجد والشموخ. من خلال استعراض تاريخها الحافل بالأمجاد، نستشعر ذلك التلاحم الفريد والعبقري بين صرامة مجريات التاريخ وعمق تضاريس الجغرافيا، وما أفرزه ذلك من قيم وطنية وإنسانية خالدة. إن دراسة مسيرة \${nameAr} تفتح أمامنا أبواباً واسعة لفهم واستيعاب طبيعة التحولات الاجتماعية والسياسية العميقة التي رافقت تطور الحضارة الإسلامية والمغربية الأصيلة عبر توالي العديد من العصور. ولم تكن يوماً بمعزل عن المتغيرات والمرحلة الحضارية الحساسة المحيطة بها، بل ساهمت بكل قوة وتأثير في توجيه دفة الأحداث الكبرى وصنع القرارات المصيرية التي غيرت وجه المنطقة برمتها بشكل نهائي وجذري.\`,
        ...
        sections: [
            {
                title: {
                    ar: 'الأبعاد التاريخية والرمزية الثرية الاستراتيجية والمؤثرة في وجدان الأمة',
                    en: 'Historical and Symbolic Dimensions Shaping Output'
                },
                content: {
                    ar: \`إن البحث الدقيق والموضوعي في جذور وتاريخ \${nameAr} يكشف لنا دائماً بكل وضوح وتجرد عن عمق وغزارة وصلابة الهوية المغربية الأصيلة، وتعدد وتشابك روافدها الثقافية والدينية والسياسية والحربية ذات الأبعاد المتلاحمة بقوة. علاوة على ذلك وعلى وجه الخصوص، احتفظت الذاكرة الشعبية والنصوص التأريخية המكتوبة بكثير من الأشعار والملاحم والبطولات الاستثنائية العظيمة التي بدورها وثقت بدقة وتواتر هذه الأمجاد العريقة ورسختها في وجدان وتكوين ووعي الأمة كحكايات واقعية تُروى بفخر وإجلال وتتجدد بقوة مع كل تحد ضخم وأزمة عويصة لتلهم معاني الصمود والثبات والصبر الطويل على المكاره والأخطار.\`,
        ...
        faqs: [
            {
                ...
                a: { ar: \`بسبب دورها المحوري في توجيه الأحداث السياسية والثقافية، ومساهمتها في ترسيخ القيم الوطنية والإسلامية العريقة التي شكلت وجدان الأمة عبر العصور.\`, en: \`Due to its pivotal role in directing political and cultural events, and its contribution to consolidating the ancient national and Islamic values that shaped the nation's conscience through the ages.\` }
            },
            {
                q: { ar: \`ما هي أبرز المعالم المعمارية أو الرمزية المتبقية لـ \${nameAr} اليوم؟\`, en: \`What are the most prominent architectural or symbolic landmarks remaining of \${nameEn} today?\` },
                a: { ar: \`تتجسد في الفنون والنقوش والأسوار والنياشين والقصص الشعبية المتواترة التي لا تزال تُدرس وتُروى كشاهد إثبات على تلك العظمة.\`, en: \`It is embodied in the arts, inscriptions, walls, medals, and recurring folk tales that are still taught and told as a witness to that greatness.\` }
            },
            {
                q: { ar: \`كيف يمكن للزوار والباحثين التفاعل مع تاريخ \${nameAr}؟\`, en: \`How can visitors and researchers interact with the history of \${nameEn}?\` },
                a: { ar: \`عبر زيارة المتاحف الوطنية، استكشاف الأرشيفات الرقمية كـ مورو فيرس، والوقوف مباشرة أمام المآثر الحية في عين المكان.\`, en: \`By visiting national museums, exploring digital archives like MoroVerse, and standing directly in front of the living monuments on site.\` }
            }
        ],
        conclusion: {
        ...
        gallery: isBattle ? battleImages : standardImages
    };
};
\`;
...
console.log('Successfully generated moroverse-content.ts with perfect .jpg links and FAQs for SEO.');
};
