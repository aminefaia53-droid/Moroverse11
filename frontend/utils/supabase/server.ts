...
export async function createClient() {
    ...
    if (!isValidUrl || !isValidKey) {
        console.warn("⚠️ SUPABASE SERVER AUTH: Environment variables are missing on the server.\n" +
            "Authentication handshake and 3D uploads will fail until this is resolved.");
    }
